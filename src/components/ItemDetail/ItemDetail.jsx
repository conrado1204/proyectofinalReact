        ...
        return(
            <div className="flex flex-col items-center">
                <div>
                    ...
                    <p className="text-4xl font-bold text-slate-700 text-center">Try visiting another page or go to <Link to="/" className="text-primaryColor hover:underline">Zephys home page</Link></p>
                </div>
                <div>
                    <img
